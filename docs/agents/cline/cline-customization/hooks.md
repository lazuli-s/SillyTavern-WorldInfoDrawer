...
> Inject custom logic into Cline's workflow to validate operations and shape Cline's decisions.
...
| PreToolUse       | Before Cline executes a tool (read\_file, write\_to\_file, etc.) |
