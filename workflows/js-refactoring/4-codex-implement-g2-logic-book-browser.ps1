...
[CmdletBinding()]
param(
    [string]$GroupDir = "tasks/js-refactoring/ready-for-implementation/group-2-logic-book-browser"
)
...
$commitMsg = "refactor(book-browser): apply js refactoring group 2 (logic-book-browser)`n`nFiles refactored:`n$bodyLines`n"
