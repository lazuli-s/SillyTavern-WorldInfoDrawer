...
import { createDeferred, debounce } from './utils.js';

let listPanelApi;
let editorPanelApi;

const setListPanelApi = (api)=>{
    listPanelApi = api;
};

const setEditorPanelApi = (api)=>{
    editorPanelApi = api;
};
...
const getUpdateWIChangeStarted = ()=>updateWIChangeStarted;
const getUpdateWIChangeFinished = ()=>updateWIChangeFinished;
...
export {
    ...
    getUpdateWIChangeFinished,
    getUpdateWIChangeStarted,
    setEditorPanelApi,
    setListPanelApi,
