...
const safeToSorted = (array, comparator) =>
  typeof array.toSorted === 'function'
...
const getSlashCommandParserCtor = async () => {
  ...
  try {
    ...
    slashCommandParserCtor =
      typeof module?.SlashCommandParser === 'function' ? module.SlashCommandParser : null;
  } catch (error) {
