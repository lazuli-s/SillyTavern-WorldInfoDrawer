...
const FOLDER_COLLAPSE_SAVE_WARNING =
  'Folder collapse state could not be saved. Browser storage may be full.';
...
const saveFolderCollapseStates = () => {
  ...
  try {
    localStorage.setItem(
      ...
      JSON.stringify(listPanelState.folderCollapseStates),
    );
    return true;
  } catch (error) {
