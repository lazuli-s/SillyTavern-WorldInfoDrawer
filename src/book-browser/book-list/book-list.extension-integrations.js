...
const createExternalEditorMenuItem = ({
  name,
  closeMenu,
  getRequestHeaders,
  createBookMenuActionItem,
...
const createStloMenuItem = ({ name, closeMenu, executeSlashCommand, createBookMenuActionItem }) =>
  createBookMenuActionItem({
...
const appendExternalEditorMenuItem = ({
  menu,
  extensionNames,
  name,
  closeMenu,
  ...
  menu.append(
    createExternalEditorMenuItem({ name, closeMenu, getRequestHeaders, createBookMenuActionItem }),
  );
};

const appendStloMenuItem = ({
  menu,
  extensionNames,
  name,
  closeMenu,
  ...
  menu.append(
    createStloMenuItem({ name, closeMenu, executeSlashCommand, createBookMenuActionItem }),
  );
};
