...
const bindFolderHeaderDropHandlers = ({
  header,
  root,
  onDrop,
  onDragStateChange,
  ...
  const actions = document.createElement('div');
  {
    ...
    const activeToggle = document.createElement('input');
    {
      ...
      activeToggle.setAttribute(
        'aria-label',
        'Toggle global active status for visible books in this folder',
      );
...
const syncFolderActiveToggleState = ({
  activeToggle,
  menuActions,
  folderName,
  visibleBookNamesOverride = null,
}) => {
...
export { createFolderDom, setFolderCollapsed, updateFolderCount };
