...
**Steps to fix:**
- [ ] Near the top of the file (before the exports), introduce a shared source of truth for entry field keys, for example: `const ENTRY_FIELD_KEYS = { POSITION: 'position' };`
- [ ] Replace the raw literal at line 7 with `ENTRY_FIELD_KEYS.POSITION` (so `SORT.POSITION` points to the shared key).
- [ ] Replace the raw literal at line 43 with `ENTRY_FIELD_KEYS.POSITION` (so the table column key points to the same shared key).
...
**Steps to fix:**
- [ ] Add `DEPTH: 'depth'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.DEPTH`).
- [ ] Replace the raw literal at line 9 with `ENTRY_FIELD_KEYS.DEPTH`.
- [ ] Replace the raw literal at line 44 with `ENTRY_FIELD_KEYS.DEPTH`.
- [ ] Replace the raw literal at line 69 with `ENTRY_FIELD_KEYS.DEPTH`.
...
**Steps to fix:**
- [ ] Add `ORDER: 'order'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.ORDER`).
- [ ] Replace the raw literal at line 11 with `ENTRY_FIELD_KEYS.ORDER`.
- [ ] Replace the raw literal at line 47 with `ENTRY_FIELD_KEYS.ORDER`.
- [ ] Replace the raw literal at line 70 with `ENTRY_FIELD_KEYS.ORDER`.
...
**Steps to fix:**
- [ ] Add `TRIGGER: 'trigger'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.TRIGGER`).
- [ ] Replace the raw literal at line 15 with `ENTRY_FIELD_KEYS.TRIGGER`.
- [ ] Replace the raw literal at line 52 with `ENTRY_FIELD_KEYS.TRIGGER`.
- [ ] Replace the raw literal at line 75 with `ENTRY_FIELD_KEYS.TRIGGER`.
...
**Steps to fix:**
- [ ] Add `STICKY: 'sticky'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.STICKY`).
- [ ] Replace the raw literal at line 48 with `ENTRY_FIELD_KEYS.STICKY`.
- [ ] Replace the raw literal at line 71 with `ENTRY_FIELD_KEYS.STICKY`.
...
**Steps to fix:**
- [ ] Add `COOLDOWN: 'cooldown'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.COOLDOWN`).
- [ ] Replace the raw literal at line 49 with `ENTRY_FIELD_KEYS.COOLDOWN`.
- [ ] Replace the raw literal at line 72 with `ENTRY_FIELD_KEYS.COOLDOWN`.
...
**Steps to fix:**
- [ ] Add `DELAY: 'delay'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.DELAY`).
- [ ] Replace the raw literal at line 50 with `ENTRY_FIELD_KEYS.DELAY`.
- [ ] Replace the raw literal at line 73 with `ENTRY_FIELD_KEYS.DELAY`.
...
**Steps to fix:**
- [ ] Add `AUTOMATION_ID: 'automationId'` to the shared entry field key object (for example: `ENTRY_FIELD_KEYS.AUTOMATION_ID`).
- [ ] Replace the raw literal at line 51 with `ENTRY_FIELD_KEYS.AUTOMATION_ID`.
- [ ] Replace the raw literal at line 74 with `ENTRY_FIELD_KEYS.AUTOMATION_ID`.
...
**Steps to fix:**
- [ ] At the top of the file (before the exports), add: `const EMPTY_TABLE_HEADER_LABEL = '';`
- [ ] Replace each occurrence of the raw literal `''` with `EMPTY_TABLE_HEADER_LABEL`.